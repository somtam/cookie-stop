    ...
    var cookieStop = {
        ...
        createBar: function () {
            var barStyle = 'position:fixed; width:100%; background-color:' + this.bg + '; color:' + this.textColour +
                    '; margin:0; left:0; line-height:2; border-bottom:1px solid ' + this.bgBorder + ';' +
                    ' top:0; padding:15px 5px; z-index:1000; text-align:center;';
            var bar = d.createElement('div');
            bar.id = cookieNameId;
            bar.style.cssText = barStyle;
            bar.innerHTML = this.cnt + ' <a href="#" id="cookieStopAccept" style="' +
                    'background-color:#f2f2f2; padding:8px 8px; text-decoration:none; ' +
